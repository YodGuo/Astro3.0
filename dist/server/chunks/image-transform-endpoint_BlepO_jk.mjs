...
import { A as AstroError, N as NoImageMetadata, p as FailedToFetchRemoteImageDimensions, R as RemoteImageNotAllowed, q as joinPaths, E as ExpectedImage, t as isRemotePath, L as LocalImageUsedWrongly, M as MissingImageDimension, U as UnsupportedImageFormat, v as IncompatibleDescriptorOptions, w as UnsupportedImageConversion, x as ExpectedImageOptions, y as ExpectedNotESMImage, z as InvalidImageService, B as ImageMissingAlt, m as maybeRenderHead, c as addAttribute, r as renderTemplate, C as FontFamilyNotFound, k as unescapeHTML } from "./sequence_IbtNAemG.mjs";
import { i as isRemoteAllowed, s as spreadAttributes } from "./worker-entry_BCrPo2Ie.mjs";
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      "./image-service-workerd_CQ8_JS7m.mjs"
    ).catch((e) => {
